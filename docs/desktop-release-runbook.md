...
- Deferred Desktop UX: publish, claim, approve, and review workbench actions. Backend publish/review tests can remain regression coverage, but they are not Desktop release exit criteria.
